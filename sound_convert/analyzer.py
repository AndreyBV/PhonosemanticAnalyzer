...
class PhonosemanticAnalyzer:
    ...
    def __init__(self, sound_letters_frequency_file, sound_letters_significance_file):
        ...
        # print(self.sound_letter_significance_dict)
...
def main():
    pass
    analyzer = PhonosemanticAnalyzer(
    ...
    sound_word = sound_extraxtor.extract("дом", [1])

    
    
    res = analyzer.analyze_sound_word(sound_word)
    #print(sound_word)
    #print(res)
